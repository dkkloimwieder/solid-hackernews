import { b as createSignal, i as insert, c as createComponent, L as Link, m as memo, a as createRenderEffect, S as Show, F as For, t as template, d as delegateEvents, s as setAttribute } from './index.js';

const _tmpl$$1 = template(`<div class="toggle"><a></a></div>`),
      _tmpl$2 = template(`<ul class="comment-children"></ul>`),
      _tmpl$3 = template(`<li class="comment"><div class="by"> <!> ago</div><div class="text"></div></li>`);
    ...
    insert(_el$, createComponent(Show, {
      ...
      get children() {
        return [(() => {
          ...
          createRenderEffect(() => _el$7.classList.toggle("open", open()));
...
const _tmpl$ = template(`<div class="item-view"><div class="item-view-header"><a target="_blank"><h1></h1></a><span v-if="item.url" class="host">(<!>)</span><p class="meta"> points | by <!> <!> ago</p></div><div class="item-view-comments"><p class="item-view-comments-header"></p><ul class="comment-children"></ul></div></div>`);
